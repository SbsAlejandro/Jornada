...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-08-2024 a las 18:09:09
...
INSERT INTO `beneficiarios` (`id`, `id_parroquia`, `descripcion`, `estatus`) VALUES
(1, 1119, 'CASA COMUNAL INDIO CARICUAO', 1);
...
CREATE TABLE `cierre_jornada` (
  ...
  `kl_distribuidos` int(11) NOT NULL,
  `kl_vendidos` int(11) NOT NULL,
  `precio_unitario_bs` float NOT NULL,
  `tasa_cambio_bcv` float NOT NULL,
  `total_bs` float NOT NULL,
  `equiv_usd` float NOT NULL,
...
INSERT INTO `especies` (`id`, `especie`, `estatus`, `fecha_registro`) VALUES
(1, 'AGUJA', 1, '2024-08-31'),
(2, 'ANCHOAS', 1, '2024-08-31'),
(3, 'ATÚN', 1, '2024-08-31'),
(4, 'ATUN COJINUA', 1, '2024-08-31'),
(5, 'MEDREGAL', 1, '2024-08-31'),
(6, 'ATUN TROMPA DE HIERRO', 1, '2024-08-31'),
(7, 'ATÚN EN RUEDA', 1, '2024-08-31'),
(8, 'ATUN LISTADO', 1, '2024-08-31'),
(9, 'ATUN LISTADO EN RUEDA', 1, '2024-08-31'),
(10, 'ATUN ALETA AMARILLA', 1, '2024-08-31'),
(11, 'ATUN ALETA AMARILLA EN RUEDA', 1, '2024-08-31'),
(12, 'ATUN ALBACORA', 1, '2024-08-31'),
(13, 'ATUN ALBACORA EN RUEDA', 1, '2024-08-31'),
(14, 'ATUN LISTADO TROZO', 1, '2024-08-31'),
(15, 'BACAYAO', 1, '2024-08-31'),
(16, 'BAGRE CACUMO', 1, '2024-08-31'),
(17, 'BAGRE', 1, '2024-08-31'),
(18, 'BAGRE BLANCO ENTERO', 1, '2024-08-31'),
(19, 'BAGRE GALLINA', 1, '2024-08-31'),
(20, 'BAGRE TONGO', 1, '2024-08-31'),
(21, 'BAGRE SIERRA', 1, '2024-08-31'),
(22, 'BAGRE EN RUEDA', 1, '2024-08-31'),
(23, 'BAGRE GUINCHE', 1, '2024-08-31'),
(24, 'BAGRE EN TROZO', 1, '2024-08-31'),
(25, 'BAGRE PEDRERO', 1, '2024-08-31');
...
--
-- Estructura de tabla para la tabla `historico_tasa_bcv`
--

CREATE TABLE `historico_tasa_bcv` (
  `id` int(11) NOT NULL,
  `id_jornada` int(11) NOT NULL,
...
CREATE TABLE `jornadas` (
  ...
  `id_vocero` int(11) NOT NULL,
  `id_doca` int(11) NOT NULL,
  `nro_familias_atender` int(11) NOT NULL,
  `id_beneficiario` int(11) NOT NULL,
  `kl_ofrecer` int(11) NOT NULL,
  `oferta` int(11) DEFAULT NULL,
  `total_kilos_ofertados` int(11) DEFAULT NULL,
  `nro_placa_caravana` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `observaciones` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_tipo_distribucion` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_origen` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_destino` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Estructura de tabla para la tabla `jor_espe`
--

CREATE TABLE `jor_espe` (
  `id` int(11) NOT NULL,
  `id_especie` int(11) NOT NULL,
  `id_jornada` int(11) NOT NULL,
  `id_presentacion` int(11) NOT NULL,
  `precio_bs` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `precio_dolares` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `disponibilidad_kl` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `vendidos_kl` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `personas` (
  `id` int(11) NOT NULL,
  `nombre_apellidos` varchar(270) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `presentacion` (`id`, `descripcion`, `estatus`) VALUES
(1, 'ENTERAS CON VISCERAS', 1),
(2, 'FILET', 1),
(4, 'EN  RUEDAS', 1),
(5, 'CON CONCHA', 1),
(7, 'PRUEBA CUATRO', 1),
...
--
-- Estructura de tabla para la tabla `temporal_jornada_especie`
--

CREATE TABLE `temporal_jornada_especie` (
  `id` int(11) NOT NULL,
  `id_especie` int(11) NOT NULL,
  `id_presentacion` int(11) NOT NULL,
  `precio_bs` float DEFAULT NULL,
  `precio_dolares` float DEFAULT NULL,
  `disponibilidad_kl` float DEFAULT NULL,
...
INSERT INTO `tipo_persona` (`id`, `descripcion`, `estatus`) VALUES
(1, 'EMMA PARROQUIAL', 1),
(2, 'SECRETARIA DE ALIMENTACION DE LA ALCALDIA DE CARACAS', 1),
(3, 'VOCERO', 1),
(4, 'OPERADOR CARAVANA O ALIADO', 1);
...
(7, 30021704, 'Tecnologia', 'TECNOLOGIA', 'NUÑEZ', 'SEBASTIANALEJANDRO427@GMAIL.COM', 'foto.png', '2023-11-07', '18101810', 1, 1),
(34, 27333664, 'jesus979', 'JESUS', 'ARANGUREN', 'JESUSARANGUREN675@GMAIL.COM', 'foto perfil jesus.jpg', '2024-08-19', '123456', 2, 1);
...
--
-- Indices de la tabla `historico_tasa_bcv`
--
ALTER TABLE `historico_tasa_bcv`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `jor_espe`
--
ALTER TABLE `jor_espe`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `temporal_jornada_especie`
--
ALTER TABLE `temporal_jornada_especie`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `historico_tasa_bcv`
--
ALTER TABLE `historico_tasa_bcv`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `jor_espe`
--
ALTER TABLE `jor_espe`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `temporal_jornada_especie`
--
ALTER TABLE `temporal_jornada_especie`
